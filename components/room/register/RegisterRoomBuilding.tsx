...
import {
    selectLargeBuildingType,
    selectBuildingType,
    selectRoomType,
    selectForGuest
} from "../../../reducers/registerRoom";
...
const RegisterRoomBuilding: React.FC = () => {
    ...
    const isSetUpForGuest = useSelector((state: any) => state.registerRoom.isSetUpForGuest);
    ...
    const onChangeRoomType = (value: string) => {
        dispatch(selectRoomType(value));
    };

    //* 게스트용 숙소 인지 변경시
    const onChangeIsSetUpForGuest = (value: any) => {
        console.log(value);
        dispatch(selectForGuest(value));
    };
